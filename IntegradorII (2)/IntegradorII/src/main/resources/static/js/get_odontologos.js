         ...
         for(odontologo of data){
           ...
           odontologoRow.id = tr_id;
            ...
            let deleteButton = '<button' +
                                ...
                                ' type="button" onclick="Swal.fire({ title: \'Eliminar odontólogo\', text: \'¿Realmente quieres eliminar el registro número ' + odontologo.id + '?\', icon: \'warning\', showCancelButton: true, confirmButtonText: \'Sí, eliminar\', cancelButtonText: \'Cancelar\' }).then((result) => { if (result.isConfirmed) { deleteBy(' + odontologo.id + '); Swal.fire(\'Eliminado\', \'El registro ha sido eliminado\', \'success\'); } else { Swal.fire(\'Cancelado\', \'Eliminación cancelada\', \'error\'); } })" class="btn btn-danger btn_delete">' +
                                '&times;' +
                                '</button>';
