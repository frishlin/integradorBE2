         ...
         for(paciente of data){
           ...
           pacienteRow.id = tr_id;
            ...
            let deleteButton = '<button' +
                                ...
                                ' type="button" onclick="Swal.fire({ title: \'Eliminar paciente\', text: \'¿Realmente quieres eliminar al paciente número ' + paciente.id + '?\', icon: \'warning\', showCancelButton: true, confirmButtonText: \'Sí, eliminar\', cancelButtonText: \'Cancelar\' }).then((result) => { if (result.isConfirmed) { deleteBy(' + paciente.id + '); Swal.fire(\'Eliminado\', \'El paciente ha sido eliminado\', \'success\'); } else { Swal.fire(\'Cancelado\', \'Eliminación cancelada\', \'error\'); } })" class="btn btn-danger btn_delete">' +
                                '&times;' +
                                '</button>';
            ...
            pacienteRow.innerHTML =
                    ...
                    '<td class=\"td_odontologo\">' + (paciente.odontologo ? paciente.odontologo.id : 'Sin Asignar') + '</td>' +
                    '<td>' + deleteButton + '</td>';
